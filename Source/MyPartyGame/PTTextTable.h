...
namespace PTText
{
     ...
     *  bHiRes=true carga la versión Flag_XX_512 (512x512) para banderas grandes (ej. HUD del espectador). */
    MYPARTYGAME_API class UTexture2D* GetLanguageFlag(const FString& Code, bool bHiRes = false);
